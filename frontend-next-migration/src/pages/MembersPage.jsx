    ...
    return (
        <div className="container mx-auto px-4 py-12">
            <div className="mb-12 text-center relative">
                ...
                <h1 className="text-4xl font-black tracking-tight mb-4 uppercase italic relative z-10 text-gradient-acm">Chapter Members</h1>
                <p className="text-muted-foreground max-w-2xl mx-auto relative z-10 font-medium">
            ...
            {isLoading ? (
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {[1, 2, 3, 4, 5, 6].map((i) => (
                        <Card key={i} className="rounded-[2rem] border-border/40 bg-card/40 backdrop-blur-sm overflow-hidden p-6">
