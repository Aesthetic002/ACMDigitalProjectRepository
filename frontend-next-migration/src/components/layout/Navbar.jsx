                    ...
                    <div className="flex items-center justify-between h-16">
                        ...
                        <div className="hidden lg:flex items-center flex-1 max-w-md mx-8">
                            <div className="relative w-full group">
                                <Search className="absolute left-3.5 top-1/2 -translate-y-1/2 h-4 w-4 text-muted-foreground group-focus-within:text-acm-blue transition-colors" />
                                <Input
                                    placeholder="Search projects, members, domains..."
                                    value={searchQuery}
                                    onChange={(e) => setSearchQuery(e.target.value)}
                                    onKeyDown={handleSearch}
                                    className="pl-10 h-10 bg-white/5 border-white/10 focus:bg-white/10 transition-all rounded-xl"
                                />
                            </div>
                        </div>
                        ...
                        <div className="flex items-center gap-2">
                            <Button
                                ...
                                size="icon"
                                onClick={toggleTheme}
                                className="w-10 h-10 rounded-xl hover:bg-white/5 transition-colors border border-transparent hover:border-border/50 shrink-0"
                            >
                            ...
                            <Button
                                variant="ghost"
                                size="icon"
                                className="relative w-10 h-10 rounded-xl hover:bg-white/5 transition-colors border border-transparent hover:border-border/50 shrink-0"
                            >
                                <Bell className="h-4 w-4 text-muted-foreground" />
                                <span className="absolute top-2.5 right-2.5 w-2 h-2 bg-acm-blue rounded-full border-2 border-background" />
                            </Button>
