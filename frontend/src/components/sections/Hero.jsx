      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          <Button
            ...
            className="group bg-primary hover:bg-primary/90 text-primary-foreground px-8 py-6 text-lg rounded-xl shadow-acm-glow hover:shadow-acm-glow-strong transition-all duration-300"
          >
        ...
        >
          {[
            ...
            <span
              key={feature}
              className="px-4 py-2 rounded-lg bg-card border border-border text-sm text-muted-foreground hover:border-primary/30 hover:text-primary transition-colors duration-300"
            >
              {feature}
            </span>
          ))}
