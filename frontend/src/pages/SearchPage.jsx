                    ...
                    <div className="mx-auto max-w-5xl">
                        ...
                        {isLoading ? (
                            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                                {[1, 2, 3].map((i) => <div key={i} className="h-[400px] animate-pulse rounded-3xl bg-muted/40 border border-border/50" />)}
                            </div>
                        ) : results.length === 0 ? (
                            <div className="flex min-h-[400px] flex-col items-center justify-center rounded-[3rem] border border-dashed border-border p-12 text-center">
                                ...
                                <div className="mt-8 flex gap-3">
                                    <Button variant="outline" onClick={() => navigate("/projects")} className="rounded-2xl px-6">Browse All</Button>
                                    <Button variant="secondary" onClick={() => { setSearchInput(""); setSearchParams({}); }} className="rounded-2xl px-6">Clear Search</Button>
                                </div>
                            </div>
                        ) : (
                            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
